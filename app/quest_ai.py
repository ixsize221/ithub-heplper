...
def sync_gpt_request(prompt: str, context: Dict[str, str], model: str = 'gpt-4') -> str:
    try:
        ...
        2. Если информации нет в контексте, скажите "нет информации обратитесь в поддержку https://rostov.ithub.ru/"
        3. Отвечайте кратко и по существу
        4. Если вопрос не связан с колледжем, вежливо сообщи ему 
